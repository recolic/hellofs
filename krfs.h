...
struct dentry *rfs_lookup(struct inode *parent_inode,
...
static inline struct rfs_superblock *RFS_SB(struct super_block *sb) {
    return sb->s_fs_info;
}
static inline struct rfs_inode *RFS_INODE(struct inode *inode) {
